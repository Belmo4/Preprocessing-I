...
* [ ] Variables: Incorporate variables in youd inside the main container.  Avoid having global styles unless they are element level.r project for color and font stacks.  
* [ ] Nesting: Every selector should be neste
